...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    private void initializeLiftOnScrollWithColor(MaterialShapeDrawable materialShapeDrawable, ColorStateList colorStateList, ColorStateList colorStateList2) {
        this.liftOnScrollColorUpdateListener = new AppBarLayout$$ExternalSyntheticLambda0(this, colorStateList, colorStateList2, materialShapeDrawable, MaterialColors.getColorOrNull(getContext(), R.attr.colorSurface));
    ...
    public /* synthetic */ void m58lambda$initializeLiftOnScrollWithColor$0$comgoogleandroidmaterialappbarAppBarLayout(ColorStateList colorStateList, ColorStateList colorStateList2, MaterialShapeDrawable materialShapeDrawable, Integer num, ValueAnimator valueAnimator) {
        Integer num2;
    ...
    public /* synthetic */ void m59lambda$initializeLiftOnScrollWithElevation$1$comgoogleandroidmaterialappbarAppBarLayout(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
