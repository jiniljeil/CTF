...
public final class UMathKt {
    ...
    private static final int m1374minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1356minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1375mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1364minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1372maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1344maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1373maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1352maxOfeb3DHEI(j, j2);
    }
}
