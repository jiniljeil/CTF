...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        boolean z = true;
        if (j3 <= 0 ? UByte$$ExternalSyntheticBackport0.m(j, j2) < 0 : UByte$$ExternalSyntheticBackport0.m(j, j2) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = ULong.m329constructorimpl(j3);
        this.next = !this.hasNext ? j2 : j;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m323boximpl(m1397nextsVKNKU());
    }
    ...
    public long m1397nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m329constructorimpl(this.step + j);
