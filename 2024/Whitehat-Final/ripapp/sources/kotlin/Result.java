...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m154boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m155constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m156equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m164unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m157equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m160hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public final /* synthetic */ Object m164unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m162isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m161isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m159getOrNullimpl(Object obj) {
        if (m161isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static String m163toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m155constructorimpl(t);
        }

        private final <T> Object failure(Throwable th) {
            Intrinsics.checkNotNullParameter(th, "exception");
            return Result.m155constructorimpl(ResultKt.createFailure(th));
        }
    }
