...
public class LinkedListChannel<E> extends AbstractChannel<E> {
    ...
    public void m1696onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
            ...
            if (!(obj instanceof ArrayList)) {
                ...
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ...
                    if (send2 instanceof AbstractSendChannel.SendBuffered) {
                        ...
                        undeliveredElementException3 = function12 != null ? OnUndeliveredElementKt.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementException3) : null;
                    } else {
