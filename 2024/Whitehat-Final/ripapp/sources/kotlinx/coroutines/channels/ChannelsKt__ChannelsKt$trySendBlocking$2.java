    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m155constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m155constructorimpl(Unit.INSTANCE);
        if (Result.m162isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1693successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1691closedJP2dKIU(Result.m158exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1678boximpl(obj3);
    }
}
