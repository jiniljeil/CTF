...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x0093, code lost:
        if (tryWaitForChild(r1, r8, r9) == false) goto L_0x0098;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r8, java.lang.Object r9) {
        ...
        L_0x001d:
            ...
            r3.<init>()
            monitor-enter(r1)
            boolean r4 = r1.isCompleting()     // Catch:{ all -> 0x009d }
            if (r4 == 0) goto L_0x002f
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x009d }
            monitor-exit(r1)
            return r8
        L_0x002f:
            r4 = 1
            r1.setCompleting(r4)     // Catch:{ all -> 0x009d }
            if (r1 == r8) goto L_0x0043
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = _state$FU     // Catch:{ all -> 0x009d }
            boolean r5 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r5, r7, r8, r1)     // Catch:{ all -> 0x009d }
            if (r5 != 0) goto L_0x0043
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x009d }
            monitor-exit(r1)
            return r8
        L_0x0043:
            boolean r5 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x009d }
            if (r5 == 0) goto L_0x0057
            boolean r5 = r1.isSealed()     // Catch:{ all -> 0x009d }
            r5 = r5 ^ r4
            if (r5 == 0) goto L_0x0051
            goto L_0x0057
        L_0x0051:
            java.lang.AssertionError r8 = new java.lang.AssertionError     // Catch:{ all -> 0x009d }
            r8.<init>()     // Catch:{ all -> 0x009d }
            throw r8     // Catch:{ all -> 0x009d }
        L_0x0057:
            boolean r5 = r1.isCancelling()     // Catch:{ all -> 0x009d }
            boolean r6 = r9 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x009d }
            if (r6 == 0) goto L_0x0063
            r6 = r9
            kotlinx.coroutines.CompletedExceptionally r6 = (kotlinx.coroutines.CompletedExceptionally) r6     // Catch:{ all -> 0x009d }
            goto L_0x0064
        L_0x0063:
            r6 = r2
        L_0x0064:
            if (r6 == 0) goto L_0x006b
            java.lang.Throwable r6 = r6.cause     // Catch:{ all -> 0x009d }
            r1.addExceptionLocked(r6)     // Catch:{ all -> 0x009d }
        L_0x006b:
            java.lang.Throwable r6 = r1.getRootCause()     // Catch:{ all -> 0x009d }
            r4 = r4 ^ r5
            java.lang.Boolean r4 = java.lang.Boolean.valueOf(r4)     // Catch:{ all -> 0x009d }
            boolean r4 = r4.booleanValue()     // Catch:{ all -> 0x009d }
            if (r4 == 0) goto L_0x007b
            r2 = r6
        L_0x007b:
            r3.element = r2     // Catch:{ all -> 0x009d }
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x009d }
            monitor-exit(r1)
            T r2 = r3.element
            java.lang.Throwable r2 = (java.lang.Throwable) r2
