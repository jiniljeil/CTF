...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m155constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
    ...
    public final java.lang.String hierarchyToString(kotlinx.coroutines.Job r10) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x00c8 }
            boolean r5 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x00c8 }
            if (r5 == 0) goto L_0x00bc
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x00c8 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x00c8 }
            java.util.ArrayList r5 = new java.util.ArrayList     // Catch:{ all -> 0x00c8 }
            r5.<init>()     // Catch:{ all -> 0x00c8 }
            java.util.Collection r5 = (java.util.Collection) r5     // Catch:{ all -> 0x00c8 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x00c8 }
        L_0x003c:
            boolean r6 = r4.hasNext()     // Catch:{ all -> 0x00c8 }
            if (r6 == 0) goto L_0x005d
            java.lang.Object r6 = r4.next()     // Catch:{ all -> 0x00c8 }
            r7 = r6
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r7 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r7     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.Continuation<T> r7 = r7.delegate     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext r7 = r7.getContext()     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.Job$Key r8 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext$Key r8 = (kotlin.coroutines.CoroutineContext.Key) r8     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext$Element r7 = r7.get(r8)     // Catch:{ all -> 0x00c8 }
            if (r7 == 0) goto L_0x003c
            r5.add(r6)     // Catch:{ all -> 0x00c8 }
            goto L_0x003c
        L_0x005d:
            java.util.List r5 = (java.util.List) r5     // Catch:{ all -> 0x00c8 }
            java.lang.Iterable r5 = (java.lang.Iterable) r5     // Catch:{ all -> 0x00c8 }
            r4 = 10
            int r4 = kotlin.collections.CollectionsKt.collectionSizeOrDefault(r5, r4)     // Catch:{ all -> 0x00c8 }
            int r4 = kotlin.collections.MapsKt.mapCapacity(r4)     // Catch:{ all -> 0x00c8 }
            r6 = 16
            int r4 = kotlin.ranges.RangesKt.coerceAtLeast((int) r4, (int) r6)     // Catch:{ all -> 0x00c8 }
            java.util.LinkedHashMap r6 = new java.util.LinkedHashMap     // Catch:{ all -> 0x00c8 }
            r6.<init>(r4)     // Catch:{ all -> 0x00c8 }
            java.util.Map r6 = (java.util.Map) r6     // Catch:{ all -> 0x00c8 }
            java.util.Iterator r4 = r5.iterator()     // Catch:{ all -> 0x00c8 }
        L_0x007c:
            boolean r5 = r4.hasNext()     // Catch:{ all -> 0x00c8 }
            if (r5 == 0) goto L_0x009b
            java.lang.Object r5 = r4.next()     // Catch:{ all -> 0x00c8 }
            r7 = r5
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r7 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r7     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.Continuation<T> r7 = r7.delegate     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext r7 = r7.getContext()     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.Job r7 = kotlinx.coroutines.JobKt.getJob(r7)     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r5 = r5.info     // Catch:{ all -> 0x00c8 }
            r6.put(r7, r5)     // Catch:{ all -> 0x00c8 }
            goto L_0x007c
        L_0x009b:
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x00c8 }
            r4.<init>()     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x00c8 }
            java.lang.String r7 = ""
            r5.build(r10, r6, r4, r7)     // Catch:{ all -> 0x00c8 }
            java.lang.String r10 = r4.toString()     // Catch:{ all -> 0x00c8 }
            java.lang.String r4 = "StringBuilder().apply(builderAction).toString()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r10, r4)     // Catch:{ all -> 0x00c8 }
        L_0x00b0:
        ...
        L_0x00bc:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00c8 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x00c8 }
            r4.<init>(r10)     // Catch:{ all -> 0x00c8 }
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r14) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0124 }
            boolean r5 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0124 }
            if (r5 == 0) goto L_0x0118
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0124 }
            r5.<init>()     // Catch:{ all -> 0x0124 }
            java.lang.String r6 = "Coroutines dump "
            java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ all -> 0x0124 }
            java.text.SimpleDateFormat r6 = dateFormat     // Catch:{ all -> 0x0124 }
            long r7 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0124 }
            java.lang.Long r7 = java.lang.Long.valueOf(r7)     // Catch:{ all -> 0x0124 }
            java.lang.String r6 = r6.format(r7)     // Catch:{ all -> 0x0124 }
            java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ all -> 0x0124 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0124 }
            r14.print(r5)     // Catch:{ all -> 0x0124 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0124 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0124 }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x0124 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r5 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x0124 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x0124 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.filter(r4, r5)     // Catch:{ all -> 0x0124 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1     // Catch:{ all -> 0x0124 }
            r5.<init>()     // Catch:{ all -> 0x0124 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0124 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0124 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x0124 }
        L_0x0070:
            boolean r5 = r4.hasNext()     // Catch:{ all -> 0x0124 }
            if (r5 == 0) goto L_0x010a
            java.lang.Object r5 = r4.next()     // Catch:{ all -> 0x0124 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x0124 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r5.info     // Catch:{ all -> 0x0124 }
            java.util.List r7 = r6.lastObservedStackTrace()     // Catch:{ all -> 0x0124 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x0124 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0124 }
            java.lang.Thread r10 = r6.lastObservedThread     // Catch:{ all -> 0x0124 }
            java.util.List r9 = r8.enhanceStackTraceWithThreadDumpImpl(r9, r10, r7)     // Catch:{ all -> 0x0124 }
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x0124 }
            java.lang.String r11 = "RUNNING"
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r11)     // Catch:{ all -> 0x0124 }
            ...
            java.lang.String r11 = r6.getState()     // Catch:{ all -> 0x0124 }
        ...
        L_0x00b4:
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x0124 }
        L_0x00b8:
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ all -> 0x0124 }
            r11.<init>()     // Catch:{ all -> 0x0124 }
            java.lang.String r12 = "\n\nCoroutine "
            java.lang.StringBuilder r11 = r11.append(r12)     // Catch:{ all -> 0x0124 }
            kotlin.coroutines.Continuation<T> r5 = r5.delegate     // Catch:{ all -> 0x0124 }
            java.lang.StringBuilder r5 = r11.append(r5)     // Catch:{ all -> 0x0124 }
            java.lang.String r11 = ", state: "
            java.lang.StringBuilder r5 = r5.append(r11)     // Catch:{ all -> 0x0124 }
            java.lang.StringBuilder r5 = r5.append(r10)     // Catch:{ all -> 0x0124 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0124 }
            r14.print(r5)     // Catch:{ all -> 0x0124 }
            boolean r5 = r7.isEmpty()     // Catch:{ all -> 0x0124 }
            if (r5 == 0) goto L_0x0105
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0124 }
            r5.<init>()     // Catch:{ all -> 0x0124 }
            java.lang.String r7 = "\n\tat "
            java.lang.StringBuilder r5 = r5.append(r7)     // Catch:{ all -> 0x0124 }
            java.lang.String r7 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r7 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r7)     // Catch:{ all -> 0x0124 }
            java.lang.StringBuilder r5 = r5.append(r7)     // Catch:{ all -> 0x0124 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0124 }
            r14.print(r5)     // Catch:{ all -> 0x0124 }
            java.util.List r5 = r6.getCreationStackTrace()     // Catch:{ all -> 0x0124 }
            r8.printStackTrace(r14, r5)     // Catch:{ all -> 0x0124 }
            goto L_0x0070
        L_0x0105:
            r8.printStackTrace(r14, r9)     // Catch:{ all -> 0x0124 }
            goto L_0x0070
        L_0x010a:
            kotlin.Unit r14 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0124 }
        L_0x010c:
        ...
        L_0x0118:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0124 }
            java.lang.String r14 = r14.toString()     // Catch:{ all -> 0x0124 }
            r4.<init>(r14)     // Catch:{ all -> 0x0124 }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m155constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m155constructorimpl(ResultKt.createFailure(th));
        }
