...
public final class DelayKt {
    ...
    public static final Object m1659delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1660toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1660toDelayMillisLRDsOJo(long j) {
        if (Duration.m1486compareToLRDsOJo(j, Duration.Companion.m1589getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1505getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
