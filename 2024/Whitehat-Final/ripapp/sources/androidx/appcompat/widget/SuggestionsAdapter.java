...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r8) {
        ...
        L_0x001a:
            ...
            java.lang.StringBuilder r2 = r2.append(r8)     // Catch:{ FileNotFoundException -> 0x007d }
        ...
        L_0x002d:
            android.content.Context r3 = r7.mProviderContext     // Catch:{ FileNotFoundException -> 0x007d }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ FileNotFoundException -> 0x007d }
            java.io.InputStream r3 = r3.openInputStream(r8)     // Catch:{ FileNotFoundException -> 0x007d }
            if (r3 == 0) goto L_0x006a
            android.graphics.drawable.Drawable r2 = android.graphics.drawable.Drawable.createFromStream(r3, r4)     // Catch:{ all -> 0x0053 }
            r3.close()     // Catch:{ IOException -> 0x0041 }
            goto L_0x0052
        L_0x0041:
            r3 = move-exception
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x007d }
            r5.<init>(r1)     // Catch:{ FileNotFoundException -> 0x007d }
            java.lang.StringBuilder r1 = r5.append(r8)     // Catch:{ FileNotFoundException -> 0x007d }
            java.lang.String r1 = r1.toString()     // Catch:{ FileNotFoundException -> 0x007d }
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x007d }
        L_0x0052:
            return r2
        L_0x0053:
            r2 = move-exception
        ...
        L_0x006a:
            ...
            r3.<init>(r2)     // Catch:{ FileNotFoundException -> 0x007d }
            java.lang.StringBuilder r2 = r3.append(r8)     // Catch:{ FileNotFoundException -> 0x007d }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x007d }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x007d }
            throw r1     // Catch:{ FileNotFoundException -> 0x007d }
        L_0x007d:
