...
public final class ViewConfigurationCompat {
    ...
    public static int getScaledMaximumFlingVelocity(Context context, ViewConfiguration viewConfiguration, int i, int i2, int i3) {
        ...
        Objects.requireNonNull(viewConfiguration);
        return getCompatFlingVelocityThreshold(resources, preApi34MaximumFlingVelocityResId, new ViewConfigurationCompat$$ExternalSyntheticLambda0(viewConfiguration), Integer.MIN_VALUE);
    }
