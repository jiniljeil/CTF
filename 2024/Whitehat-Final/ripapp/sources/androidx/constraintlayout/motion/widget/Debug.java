...
import com.example.ripapp2.BuildConfig;
...
public class Debug {
    ...
    public static String getState(MotionLayout motionLayout, int i, int i2) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - i2) / length).toString().replace(0, '.') + "_", "_");
    }
