    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = "_";
                StringBuilder append = new StringBuilder().append(((constraintWidget.mTop.mTarget != null ? "T" : str4) + (constraintWidget.mBottom.mTarget != null ? "B" : str4)) + (constraintWidget.mLeft.mTarget != null ? "L" : str4));
                if (constraintWidget.mRight.mTarget != null) {
                    str4 = "R";
                }
