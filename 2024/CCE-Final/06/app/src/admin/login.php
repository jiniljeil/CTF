<?php
	...
	if(is_login() && is_admin()) alert("Already Login", "./");
	...
	if($_POST){
		...
		if(($id_check['is_admin'] != 1) || ($id_check['password'] !== $pw)) alert('Login Fail', 'back');
		...
		<div class="h_cont">
			...
			<div class="gnb">
				<ul class="gnb_list">
					...
					<li><a href="/admin/" target="_blank"><img src="/static/gnb_bz.gif" alt="관리자전용홈페이지"></a></li>
				</ul>
			</div>
		</div>
	</div>
            ...
            <div class="section02">
                <div class="cont_login">
                    <div class="box_lef">
                        ...
                        <fieldset>
                        <legend class="u_hc">고레일 관리자 로그인</legend>
                            <div class="log_chg al_lft" id="loginDisplay1" style="display:block;">
                                <div class="login-title" style="font-family: 'Noto Sans KR', sans-serif;">고레일 관리자 로그인</div>
                                <ul class="login_mem">
                                       <li>
                                ...
                                <p class="chkbox"><span class="eml mg_lft0"></label></span>
                                    <span style="position:absolute;right:0;top:-8px;">
                                        <a href="/join"><span class="btn_gray_ang" style="padding:5px 5px; cursor:pointer">멤버십 가입</span></a>
                                    </span>
                                </p>
                            </div>
                        </fieldset>
