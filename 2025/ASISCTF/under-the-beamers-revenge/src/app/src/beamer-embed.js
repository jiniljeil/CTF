...
var _BEAMER_DATE = "_BEAMER_DATE",
    ...
    _BEAMER_MASSIVE = !1,
    _BEAMER_IS_OPEN = !1,
    _BEAMER_PUSH_PROMPT_TYPE, _BEAMER_PUSH_PROMPT_LABEL, _BEAMER_PUSH_PROMPT_ACCEPT, _BEAMER_PUSH_PROMPT_REFUSE, _BEAMER_LOGO_URL, _BEAMER_SHOW_PUSH_PROMPT = !1,
...
Beamer.build = function () {
    if ("undefined" === typeof Beamer.built || !Beamer.built) {
        ...
        var a = function (b) {
            ...
            } catch (c) { } else if (window.beamer_config && "undefined" !== typeof beamer_config.product_id && "" !== beamer_config.product_id.trim() || window.beamer_config && "undefined" !== typeof beamer_config.lazy && beamer_config.lazy) {
                if ("undefined" == typeof beamer_config.lazy || !beamer_config.lazy)
                    if (void 0 != beamer_config.mobile &&
                        !beamer_config.mobile && Beamer.isMobile()) try {
                            console.log("Mobile version is disabled by configuration. (mobile:false).")
                        } catch (c) { } else "number" == typeof beamer_config.delay && 0 < beamer_config.delay ? setTimeout(Beamer.init, beamer_config.delay) : Beamer.init()
            } else setTimeout(function () {
                a(++b)
            }, 1E3)
        };
        window.beamer_config && Beamer.isEmbedMode() ? a(0) : setTimeout(function () {
            a(0)
        }, 500)
    }
};
...
Beamer.updateUrl = function () {
    var a = function () {
        "undefined" !== typeof beamer_config.filter_by_url && beamer_config.filter_by_url && "undefined" !== typeof Beamer.fullUrl && Beamer.appendAlert(!0, !0);
        "undefined" !== typeof Beamer.config && "undefined" !== typeof Beamer.config.enableNPS && Beamer.config.enableNPS && Beamer.shouldShowNPS(Beamer.config.npsShowForUrls, Beamer.config.npsHideForUrls) && Beamer.appendNPSScript()
    };
    encodeURIComponent(window.location.href) !== Beamer.fullUrl && ("undefined" === typeof Beamer.config || "undefined" ===
        typeof Beamer.config.blockedUrls && "undefined" === typeof Beamer.config.allowedUrls ? a() : Beamer.checkUrlAllowed(Beamer.config).then(function () {
...
Beamer.remove = function (a) {
    ...
    "undefined" !== typeof Beamer.notificationScriptTimeout && (clearTimeout(Beamer.notificationScriptTimeout), delete Beamer.notificationScriptTimeout);
...
Beamer.showFeed = function (a, b) {
    if (Beamer.enabled) {
        ...
        if ("undefined" !== typeof beamer_config.standalone && beamer_config.standalone) window.open(Beamer.buildStandaloneUrl(), "_blank"), Beamer.setDateCookie((new Date).toISOString(),
            300), Beamer.clearAlert();
        else {
            _BEAMER_IS_OPEN = !0;
            var d = "";
            if ("undefined" != typeof beamer_config.display && "popup" == beamer_config.display) {
                ...
                if (a) {
                    ...
                    a.clientX <= ("innerWidth" in window ? window.innerWidth : document.documentElement.offsetWidth) / 2 && (e = "beamer_left");
            ...
            if (null != document.getElementById(h)) {
                if ("undefined" !==
                    typeof Beamer.displayedFeedType && Beamer.displayedFeedType !== b || window._BEAMER_CHANGELOG_POST_ID && "news" === b) Beamer.displayedFeedType = b, document.getElementById("beamerNews").src = Beamer.buildFeedUrl(b);
                if (Beamer.isInApp())
                    if ("undefined" !== typeof a && a.target && Beamer.isElementVisible(a.target)) {
                        ...
                        null !== k && Beamer.forEachElement("beamerNews, beamerLoader", function (l) {
                ...
                setTimeout(function () {
                    ...
                    Beamer.sendMessageToIframe("setRefUrl:" + JSON.stringify({
                ...
                if (!Beamer.initialized) {
                    ...
                    var n = Beamer.buildFeedUrl(b),
                        u;
                    "undefined" ==
                        typeof beamer_config.display || "left" !== beamer_config.display && "right" !== beamer_config.display && "popup" !== beamer_config.display ? Beamer.isInApp() && (u = "popup inapp") : u = beamer_config.display;
                    u || (u = "right");
                    var t = "<div class='beamer_mock_header'",
                        w = "undefined" !== typeof beamer_config.header_color ? beamer_config.header_color : Beamer.getFromStorage(_BEAMER_HEADER_COLOR);
                    w && (t += ' style="background-color: ' + w + ';"');
                    t += "></div>";
                    "undefined" !== typeof Beamer.escapeHtml && (n = Beamer.escapeHtml(n));
                    var v = "<div id='beamerLoader' class='beamer_beamer " +
                        u + "'>" + t + "</div>" + Beamer.buildFeedIframe(n, u);
                    Beamer.isInApp() || (v = "<div id='beamerOverlay'><div class='iframeCointaner'><div id='beamerLoader' class='beamer_beamer " + u + "'>" + t + "</div>" + Beamer.buildFeedIframe(n, u) + "</div></div>");
                    Beamer.isEmbedMode() ? Beamer.forEachElement(beamer_config.selector, function (m) {
                        Beamer.appendHtml(m, v)
                    }) : Beamer.appendHtml(document.body, v);
                    Beamer.addClick("beamerOverlay", Beamer.hide)
                }
                _BEAMER_SHOW_PUSH_PROMPT && "undefined" === typeof Beamer.pushDomain && Beamer.forEachElement("beamerNews",
                    function (m) {
                        m.onload = Beamer.showNotificationPrompt(2E3)
                    });
                Beamer.isInApp() && !Beamer.isEmbedMode() && Beamer.forEachElement("beamerNews, beamerLoader", function (m) {
                    ...
                    if ("undefined" !== typeof l && l.target && Beamer.isElementVisible(l.target)) {
                        ...
                        null !== q && (Beamer.setPopperPosition(m,
                            q), Beamer.updatePopper(q))
                    }
            ...
            })(a), Beamer.showElement(h), Beamer.removeClass(h, "beamer_hide"), Beamer.removeClass(h, "beamer_hideable"), c = Beamer.isInApp() ? 250 : 50, setTimeout(function () {
                Beamer.addClass(h, d);
                Beamer.addClass(h, "beamer_show")
            },
                c), setTimeout(function () {
                    Beamer.addClass(h, "beamer_hideable")
                }, c + 250), Beamer.setDateCookie((new Date).toISOString(), 300), Beamer.clearAlert();
            Beamer.isEmbedMode() || (Beamer.isInApp() ? (Beamer.isMobile() && Beamer.addClassBody("beamer_noscroll"), setTimeout(function () {
            ...
            }, 50)) : Beamer.addClassBody("beamer_noscroll"), Beamer.isMobile() && (Beamer.addClassBody("beamer_mobile"), Beamer.isAndroid() &&
                Beamer.addClassBody("android")));
...
Beamer.hide = function () {
    ...
    setTimeout(function () {
        ...
        Beamer.removeOnHide && setTimeout(function () {
            Beamer.removeIframe();
            Beamer.removeOnHide = !1
        }, 250)
    }, 10)
...
Beamer.buildFeedIframe = function (a, b) {
    return '<iframe allowfullscreen src="' + a + "\" id='beamerNews' class='beamer_beamer " + b + "' data-powered-by='Newsfeed and changelog powered by Beamer. https://www.getbeamer.com' title='Beamer' aria-label='Beamer widget'></iframe>"
};
Beamer.switchIframe = function (a) {
    if (!("undefined" === typeof a || "" === a.trim() || 0 !== a.toLowerCase().indexOf(_BEAMER_URL) || -1 < a.toLowerCase().indexOf("javascript:"))) {
        ...
        if (0 !== b.length) {
            ...
            var d = !1,
                e = function () {
                    d || (d = !0, Beamer.addClass(".beamer_beamer", "beamer_switching"), b.style.opacity = "0 !important", setTimeout(function () {
                        b.parentNode.removeChild(b);
                        Beamer.removeClass(".beamer_beamer",
                            "beamer_cloned");
                        Beamer.removeClass(".beamer_beamer", "beamer_switching")
                    }, 100), Beamer.unbindWindowEvent("loaded", e))
                };
            c.onload = e;
            Beamer.bindWindowEvent("loaded", e);
            b.className += " beamer_original";
            b.parentNode.insertBefore(c, b.nextSibling);
            Beamer.isInApp() && !Beamer.isEmbedMode() && Beamer.forEachElement(beamer_config.selector, function (g) {
...
Beamer.toggle = function (a) {
    if (Beamer.isEmbedMode()) Beamer.show(a);
        ...
        if ("undefined" === typeof Beamer.lastToggle || 200 < b - Beamer.lastToggle) _BEAMER_IS_OPEN ? Beamer.hide() : Beamer.show(a)
    }
};
...
Beamer.addClass = function (a, b) {
    try {
        "string" === typeof a ? Beamer.forEachElement(a, function (c) {
...
Beamer.addClick = function (a, b) {
    var c = function (e) {
        ...
        "undefined" !== typeof g && g || (Beamer.addEventListener(e, "keypress", function (n) {
        ...
        if ((g = e.querySelectorAll("a")) && 0 < g.length)
            for (var f = 0; f < g.length; f++) {
                var h = g[f];
                "undefined" === typeof h.hasAttribute || h.hasAttribute("data-wpel-link") ||
                    (h.href = d);
                var k = !1,
                    l = function (n) {
                        k = !0;
                ...
                try {
                    ...
                    }, Beamer.removeEventListener(h, "ontouchstart", l), Beamer.addEventListener(h, "ontouchstart", l))
                } catch (n) { }
            }
    },
...
Beamer.appendStyles = function (a) {
    ...
    c || (c = document.createElement("link"), c.id = b, c.type = "text/css", c.rel = "stylesheet", Beamer.isEmbedMode() ? c.href = _BEAMER_URL + "styles/beamer-embed-nostyle.css?v=3" : c.href = _BEAMER_URL + "styles/beamer-embed.css?v=9", c.onload = function () {
...
Beamer.appendFont = function () {
    if (!("undefined" !== typeof Beamer.config && "undefined" !== typeof Beamer.config.disableFontImport && Beamer.config.disableFontImport || "undefined" !== typeof beamer_config.import_font && !beamer_config.import_font)) {
        var a = document.getElementById("beamerFont");
        a || (a = document.createElement("link"), a.id = "beamerFont", a.type = "text/css", a.rel = "stylesheet", a.href = _BEAMER_URL + "styles/beamer-embed-fonts.css", document.head.appendChild(a))
    }
};
...
Beamer.appendPushScript = function (a) {
    if (!(Beamer.isSafari() || Beamer.isIE() || Beamer.isFacebookApp() || Beamer.isInstagramApp()))
        if ("undefined" !== typeof Beamer.pushDomain) (Beamer.pushDomain == window.location.host || "undefined" !== typeof Beamer.extendedPushDomain && Beamer.extendedPushDomain && window.location.host.endsWith("." + Beamer.pushDomain)) && Beamer.appendPushPermissionScript(a);
    ...
    try {
        Beamer.appendPushSDKScript(function () {
            ...
            if (!a) {
                ...
                beamer_config.filter ? b += "&role=" + encodeURIComponent(beamer_config.filter) : beamer_config.role && (b += "&role=" + encodeURIComponent(beamer_config.role));
                var c = Beamer.getCookie(_BEAMER_USER_ID + "_" + beamer_config.product_id);
                c && (b += "&user_id=" + c);
                beamer_config.language ? b += "&language=" + beamer_config.language :
                    (c = window.navigator.userLanguage || window.navigator.language) && 1 < c.length && (c = c.substring(0, 2).toUpperCase(), b += "&language=" + c);
                "undefined" != typeof beamer_config.user_id && "user_id" != beamer_config.user_id && (b += "&custom_user_id=" + encodeURIComponent(beamer_config.user_id));
                "undefined" != typeof beamer_config.user_lastname && "lastname" != beamer_config.user_lastname && (b += "&user_lastname=" + encodeURIComponent(beamer_config.user_lastname));
                "undefined" != typeof beamer_config.user_firstname && "firstname" != beamer_config.user_firstname &&
                    (b += "&user_firstname=" + encodeURIComponent(beamer_config.user_firstname));
                "undefined" != typeof beamer_config.user_email && "email" != beamer_config.user_email && (b += "&user_email=" + encodeURIComponent(beamer_config.user_email));
                "undefined" != typeof beamer_config.user_token && "user_token" != beamer_config.user_token && (b += "&user_token=" + encodeURIComponent(beamer_config.user_token));
...
Beamer.appendPushSDKScript = function (a) {
    try {
        ...
        b || (b = document.createElement("script"), b.id = "beamerPushSDKAppScript", b.type = "text/javascript", b.onload = function () {
            var c = document.getElementById("beamerPushSDKMessagingScript");
            c || (c = document.createElement("script"), c.id = "beamerPushSDKMessagingScript", c.type = "text/javascript", c.onload = function () {
                "undefined" !== typeof a && Beamer.isFunction(a) && a()
            }, c.src = "https://www.gstatic.com/firebasejs/10.13.1/firebase-messaging-compat.js",
                document.head.appendChild(c))
        }, b.src = "https://www.gstatic.com/firebasejs/10.13.1/firebase-app-compat.js", document.head.appendChild(b))
    } catch (c) { }
};
Beamer.appendNPSScript = function () {
    ...
    "undefined" !== typeof beamer_config.nps_delay && 0 < beamer_config.nps_delay ? setTimeout(a, beamer_config.nps_delay) : a()
};
...
Beamer.appendUtilitiesIframe = function (a) {
    if ("undefined" === typeof Beamer.config.disableUtilitiesIframe || !Beamer.config.disableUtilitiesIframe) try {
        ...
        "undefined" !==
            typeof Beamer.customDomain && Beamer.setIframeCookies();
...
Beamer.setIframeCookies = function () {
    var a = _BEAMER_USER_ID + "_" + beamer_config.product_id,
        ...
        c = "setCookies:" + JSON.stringify([{
            name: a,
            value: b,
            expiration: 300
        }]);
    for (a = 1; 10 >= a; a++) setTimeout(function () {
...
Beamer.initUpdatesListener = function () {
    ...
    for (var b = 1; 10 >= b; b++) setTimeout(function () {
        ...
        setTimeout(function () {
            if ("undefined" !== typeof Beamer.pushDomain) Beamer.appendPushPromptScript();
                ...
                if ("popup" == _BEAMER_PUSH_PROMPT_TYPE) {
                    ...
                    if (!c) {
                        c = _BEAMER_LOGO_URL ? '<div class="pushContentImage" style="background-image:url(\'' + _BEAMER_LOGO_URL + "')\"></div>" : '<div class="pushContentImage"></div>';
                        var d = "",
                            e = "",
                            g = "",
                            f = "",
                            h = "";
                        null != Beamer.config.pushBodyBackgroundColor ? (d = '<div class="pushContent" style="background-color:' + Beamer.config.pushBodyBackgroundColor + ';">', e = '<div class="pushActions" style="background-color:' +
                            Beamer.config.pushBodyBackgroundColor + ';">') : (d = '<div class="pushContent">', e = '<div class="pushActions">');
                        g = null != Beamer.config.pushBodyTextColor ? '<div class="pushContentText" id="beamerPushModalContent" style="color:' + Beamer.config.pushBodyTextColor + ';">' : '<div class="pushContentText" id="beamerPushModalContent">';
                        f = null != Beamer.config.pushPrimaryButtonBackgroundColor && null != Beamer.config.pushPrimaryButtonTextColor ? '<a id="pushConfirmation" class="pushButton" href="javascript:void(0)" role="button" style="background-color:' +
                            Beamer.config.pushPrimaryButtonBackgroundColor + " !important; color:" + Beamer.config.pushPrimaryButtonTextColor + ' !important;">' : null != Beamer.config.pushPrimaryButtonBackgroundColor && null == Beamer.config.pushPrimaryButtonTextColor ? '<a id="pushConfirmation" class="pushButton" href="javascript:void(0)" role="button" style="background-color:' + Beamer.config.pushPrimaryButtonBackgroundColor + ' !important;">' : null == Beamer.config.pushPrimaryButtonBackgroundColor && null != Beamer.config.pushPrimaryButtonTextColor ?
                                '<a id="pushConfirmation" class="pushButton" href="javascript:void(0)" role="button" style="color:' + Beamer.config.pushPrimaryButtonTextColor + ' !important;">' : '<a id="pushConfirmation" class="pushButton" href="javascript:void(0)" role="button">';
                        h = null != Beamer.config.pushSecondaryButtonTextColor ? '<a id="pushActionRefuse" href="javascript:void(0)" role="button" style="color:' + Beamer.config.pushSecondaryButtonTextColor + ';">' : '<a id="pushActionRefuse" href="javascript:void(0)" role="button">';
                        c = '<div class="pushModal" id="beamerPushModal" role="dialog" aria-describedby="beamerPushModalContent">' +
                            d + c + g + _BEAMER_PUSH_PROMPT_LABEL + "</div></div>" + e + h + _BEAMER_PUSH_PROMPT_REFUSE + "</a>" + f + _BEAMER_PUSH_PROMPT_ACCEPT + "</a></div></div>";
                        Beamer.appendHtml(document.body, c);
                        Beamer.addClick("pushActionRefuse", function () {
                            Beamer.hideNotificationPrompt();
                            Beamer.refuseNotifications();
                            Beamer.setCookie(_BEAMER_LAST_PUSH_PROMPT_INTERACTION + "_" + beamer_config.product_id, (new Date).getTime(), 300)
                        });
                        Beamer.addClick("pushConfirmation", function () {
                            Beamer.openNotificationPopup();
                            Beamer.hideNotificationPrompt();
                            Beamer.setCookie(_BEAMER_LAST_PUSH_PROMPT_INTERACTION +
                                "_" + beamer_config.product_id, (new Date).getTime(), 300)
                        })
                    }
                    setTimeout(function () {
                        Beamer.addClass("beamerPushModal", "active")
                    }, 300)
                } else "sidebar" == _BEAMER_PUSH_PROMPT_TYPE && (_BEAMER_IS_OPEN ? (Beamer.sendMessageToIframe("requestNotificationsPermission"), _BEAMER_SHOW_PUSH_PROMPT = !1) : _BEAMER_SHOW_PUSH_PROMPT = !0)
        }, a)
    }
};
Beamer.hideNotificationPrompt = function () {
    _BEAMER_PUSH_PROMPT_TYPE && "popup" == _BEAMER_PUSH_PROMPT_TYPE && (Beamer.removeClass(".pushModal", "active"), setTimeout(function () {
...
Beamer.openNotificationPopup = function () {
    ...
    beamer_config.language ? a += "&language=" + beamer_config.language : (b = window.navigator.userLanguage || window.navigator.language) && 1 < b.length && (b = b.substring(0, 2).toUpperCase(), a += "&language=" + b);
    a += "&ref=" + encodeURIComponent(window.location.href);
    a = window.open(a, "Enable notifications", "scrollbars=no, width=800, height=600, top=" +
...
Beamer.appendAlert = function (a, b) {
    if (Beamer.enabled && ("undefined" !== typeof beamer_config.product_id || "undefined" !== typeof beamer_config.product)) {
        var c = function () {
            if (!Beamer.isEmbedMode() && ("undefined" == typeof beamer_config.alert || beamer_config.alert)) {
                if (0 === Beamer.findElements(beamer_config.selector).length || "undefined" !== typeof beamer_config.force_button && beamer_config.force_button) {
                    if (!(void 0 == beamer_config.button || beamer_config.button || "undefined" !== typeof beamer_config.force_button && beamer_config.force_button)) return;
                    if (0 === Beamer.findElements("beamerSelector").length) {
                        beamer_config.selector = beamer_config.selector && "" !== beamer_config.selector ? beamer_config.selector + ", beamerSelector" : "beamerSelector";
                        var f = !1;
                        beamer_config.button_position && (f = beamer_config.button_position.trim(), f = "top-left" == f || "top-right" == f || "bottom-right" == f || "bottom-left" == f);
                        ...
                        f = '<div id="beamerSelector" class="' +
                            h + '" tabindex="0" role="button"';
                        h = Beamer.getFromStorage(_BEAMER_SELECTOR_COLOR);
                        Beamer.appendHtml(document.body, (h ? f + (' style="display: none; background-color: ' + h + ';"') : f + ' style="display: none;"') + "></div>");
                        Beamer.setPosition(".beamer_defaultBeamerSelector");
                        Beamer.defaultSelector = !0;
                        _BEAMER_CSS_LOADED ? Beamer.clearDisplayFromElement(".beamer_defaultBeamerSelector") : setTimeout(function () {
                            Beamer.clearDisplayFromElement(".beamer_defaultBeamerSelector")
                        }, 5E3)
                    }
                }
                Beamer.forEachElement(beamer_config.selector,
                    function (k) {
        ...
        Beamer.ajax(e, function (f) {
            f = JSON.parse(f);
            Beamer.setParameters(f);
            "undefined" !== typeof f.lastViewDate && "" !== f.lastViewDate.trim() && (d = f.lastViewDate,
                Beamer.setDateCookie(d, 300));
            if (void 0 != beamer_config.mobile && !beamer_config.mobile && Beamer.isMobile()) try {
                console.log("Mobile version is disabled by configuration. (mobile:false).")
            } catch (n) { } else {
                Beamer.isInApp() && Beamer.appendPopperScript();
                Beamer.appendStyles();
                Beamer.isEmbedMode() && ("undefined" === typeof beamer_config.show || beamer_config.show || Beamer.hasOpenHash()) ? (Beamer.hasOpenHash() && (Beamer.isHashOpen = !0), setTimeout(function () {
                    Beamer.show()
                }, 500)) : Beamer.hasOpenHash() && (Beamer.isHashOpen = !0, Beamer.isInApp() && "undefined" === typeof Popper ? setTimeout(function (n) {
                    Beamer.show()
                }, 2E3) : Beamer.show());
                c();
                var h = !1;
                a || (Beamer.notificationColor = Beamer.getConfigParameter(f, "notificationColor"));
                Beamer.isHashOpen && !a ? (Beamer.notificationNumber = 0, Beamer.notificationActive = !1) : 0 < f.number ? (h = f.number > Beamer.notificationNumber, Beamer.notificationNumber = f.number, Beamer.notificationActive = !0) : null == d || "" == d || "undefined" !== typeof f.forceDeviceSync && f.forceDeviceSync ? "undefined" !== typeof beamer_config.first_visit_unread ?
                    0 < beamer_config.first_visit_unread ? (Beamer.notificationNumber = beamer_config.first_visit_unread, Beamer.notificationActive = !0) : (Beamer.notificationNumber = 0, Beamer.notificationActive = !1, setTimeout(function () {
                        Beamer.setDateCookie((new Date).toISOString(), 300)
                    }, 500)) : (Beamer.notificationNumber = 0, Beamer.notificationActive = !0) : (Beamer.notificationNumber = 0, Beamer.notificationActive = !1);
                ("undefined" == typeof beamer_config.alert || beamer_config.alert || "undefined" !== typeof beamer_config.counter && beamer_config.counter) &&
                    Beamer.drawAlert();
                ...
                !f.priority || "undefined" !== typeof beamer_config.ignore_auto_open && beamer_config.ignore_auto_open ||
                    Beamer.isMobile() && "undefined" !== typeof beamer_config.ignore_auto_open_mobile && beamer_config.ignore_auto_open_mobile || setTimeout(function () {
                        Beamer.show()
                    }, 500);
                ("undefined" !== typeof f.lastPostTitle && "" !== f.lastPostTitle || "undefined" !== typeof f.lastPostId) && Beamer.showLastPost(f);
                k = Beamer.getConfigParameter(f, "pushNotificationsPromptEnabled");
                ("undefined" !== typeof k && k || a && Beamer.pushEnabled) && (!a || "undefined" !== typeof b && b) && (Beamer.pushDomain = Beamer.getConfigParameter(f, "pushDomain"), Beamer.extendedPushDomain =
                    Beamer.getConfigParameter(f, "extendedPushDomain"), Beamer.pushEnabled = !0, a || (_BEAMER_PUSH_PROMPT_TYPE = beamer_config.notification_prompt ? beamer_config.notification_prompt : Beamer.getConfigParameter(f, "pushNotificationsPromptType"), (k = Beamer.getConfigParameter(f, "pushNotificationsPrompt")) && (_BEAMER_PUSH_PROMPT_LABEL = k), (k = Beamer.getConfigParameter(f, "pushNotificationsPromptAccept")) && (_BEAMER_PUSH_PROMPT_ACCEPT = k), (k = Beamer.getConfigParameter(f, "pushNotificationsPromptRefuse")) && (_BEAMER_PUSH_PROMPT_REFUSE =
                        k), (k = Beamer.getConfigParameter(f, "logoUrl")) && (_BEAMER_LOGO_URL = k)), "undefined" !== typeof beamer_config.notification_prompt_delay && 0 < beamer_config.notification_prompt_delay && ("undefined" === typeof b || !b) ? Beamer.notificationScriptTimeout = setTimeout(function () {
                            Beamer.appendPushScript();
                            delete Beamer.notificationScriptTimeout
                        }, beamer_config.notification_prompt_delay) : Beamer.appendPushScript());
                a || (k = Beamer.getConfigParameter(f, "customDomain"), "undefined" !== typeof k && (Beamer.customDomain = k, Beamer.appendUtilitiesIframe()),
                    Beamer.initDomObserver(), k = Beamer.getConfigParameter(f, "enableSoundNotification"), "undefined" !== typeof k && k && (Beamer.enableSoundNotification = !0), k = Beamer.getConfigParameter(f, "enableFaviconNotification"), "undefined" !== typeof k && k && (Beamer.enableFaviconNotification = !0, Beamer.appendFaviconScript()));
                ...
                if (!Beamer.isEmbedMode() && ("undefined" === typeof beamer_config.auto_refresh ||
                    beamer_config.auto_refresh) && "undefined" !== typeof l && l && "undefined" !== typeof k && k) {
                    if (h || "undefined" !== typeof b && b) _BEAMER_IS_OPEN ? Beamer.removeOnHide = !0 : Beamer.removeIframe(), Beamer.setCookie(_BEAMER_LAST_UPDATE + "_" + beamer_config.product_id, (new Date).getTime(), 300);
                    ...
                    h = Beamer.getConfigParameter(f,
                        "enableUpdatesListener");
                    "undefined" !== typeof h && h ? (f = Beamer.getConfigParameter(f, "updatesDelay"), "undefined" !== typeof f && 0 <= f && (Beamer.updatesMaxDelay = f), Beamer.appendUtilitiesIframe(!0)) : Beamer.prepareAutoRefresh()
                } else "undefined" !== typeof b && b && (_BEAMER_IS_OPEN ? Beamer.removeOnHide = !0 : Beamer.removeIframe(), Beamer.setCookie(_BEAMER_LAST_UPDATE + "_" + beamer_config.product_id, (new Date).getTime(), 300))
            }
        }, function () {
...
Beamer.bindFeedbackButtons = function () {
    "undefined" !== typeof Beamer.config.ideasEnabled && Beamer.config.ideasEnabled && ("undefined" !== typeof beamer_config.ideas_selector && "" !== beamer_config.ideas_selector.trim() ? (0 > beamer_config.ideas_selector.indexOf(".beamerIdeasTrigger") && (beamer_config.ideas_selector += ",.beamerIdeasTrigger"), 0 > beamer_config.ideas_selector.indexOf('a[href="#beamerIdeasTrigger"]') && (beamer_config.ideas_selector += ',a[href="#beamerIdeasTrigger"]')) : beamer_config.ideas_selector = '.beamerIdeasTrigger,a[href="#beamerIdeasTrigger"]',
        Beamer.addClass(beamer_config.ideas_selector, "beamer_beamerSelector"), Beamer.addClick(beamer_config.ideas_selector, Beamer.handleIdeasButtonClick), "undefined" !== typeof beamer_config.ideas_form_selector && "" !== beamer_config.ideas_form_selector.trim() ? (0 > beamer_config.ideas_form_selector.indexOf(".beamerIdeasFormTrigger") && (beamer_config.ideas_form_selector += ",.beamerIdeasFormTrigger"), 0 > beamer_config.ideas_form_selector.indexOf('a[href="#beamerIdeasFormTrigger"]') && (beamer_config.ideas_form_selector +=
            ',a[href="#beamerIdeasFormTrigger"]')) : beamer_config.ideas_form_selector = '.beamerIdeasFormTrigger,a[href="#beamerIdeasFormTrigger"]', Beamer.addClass(beamer_config.ideas_form_selector, "beamer_beamerSelector"), Beamer.addClick(beamer_config.ideas_form_selector, Beamer.handleIdeasFormButtonClick));
    "undefined" !== typeof Beamer.config.roadmapEnabled && Beamer.config.roadmapEnabled && ("undefined" !== typeof beamer_config.roadmap_selector && "" !== beamer_config.roadmap_selector.trim() ? (0 > beamer_config.roadmap_selector.indexOf(".beamerRoadmapTrigger") &&
...
Beamer.removeFeedbackButtons = function () {
    ...
    "undefined" !== typeof beamer_config.ideas_selector && "" !== beamer_config.ideas_selector && Beamer.removeClass(beamer_config.ideas_selector, "beamer_beamerSelector");
    "undefined" !== typeof beamer_config.ideas_form_selector && "" !== beamer_config.ideas_form_selector && Beamer.removeClass(beamer_config.ideas_form_selector, "beamer_beamerSelector");
    "undefined" !== typeof beamer_config.roadmap_selector &&
        "" !== beamer_config.roadmap_selector && Beamer.removeClass(beamer_config.roadmap_selector, "beamer_beamerSelector")
};
Beamer.prepareAutoRefresh = function (a) {
    "undefined" === typeof a && (a = Beamer.autoRefreshTimeout);
    "undefined" !== typeof a && ("undefined" !== typeof Beamer.autoTimeout && clearTimeout(Beamer.autoTimeout), Beamer.autoTimeout = setTimeout(function () {
...
Beamer.buildFeedUrl = function (a, b, c) {
    var d = _BEAMER_URL + a;
    d = -1 < d.indexOf("?") ? d + "&" : d + "?";
    d = "undefined" != typeof beamer_config.product_id ? d + ("app_id=" + beamer_config.product_id) : d + ("id=" + beamer_config.product);
    "undefined" !== typeof window._BEAMER_CHANGELOG_POST_ID && window._BEAMER_CHANGELOG_POST_ID && (d += "&featureId=" + encodeURIComponent(window._BEAMER_CHANGELOG_POST_ID));
    if (0 !== a.indexOf("popup")) {
        if (c = Beamer.getDateCookie(), a = "undefined" !== typeof beamer_config.filter_by_url && beamer_config.filter_by_url ?
            ...
            if (c = "popup", "undefined" !== typeof beamer_config.theme && (c += " " + beamer_config.theme), "popup" === beamer_config.display) d += "&theme=" + c;
            else if ("in-app" === beamer_config.display || "compact" === beamer_config.display) d += "&theme=" + c + "&in_app=true"
    } else a = encodeURIComponent(window.location.host), d += "&url=" + a, "undefined" != typeof beamer_config.user_token && "user_token" != beamer_config.user_token && (d += "&user_token=" + encodeURIComponent(beamer_config.user_token)), "undefined" !==
        typeof c && c && ((c = Beamer.getCookie(_BEAMER_USER_ID + "_" + beamer_config.product_id)) && (d += "&user_id=" + c), "undefined" != typeof beamer_config.user_id && "user_id" != beamer_config.user_id && (d += "&custom_user_id=" + encodeURIComponent(beamer_config.user_id)), "undefined" != typeof beamer_config.user_lastname && "lastname" != beamer_config.user_lastname && (d += "&lastname=" + encodeURIComponent(beamer_config.user_lastname)), "undefined" != typeof beamer_config.user_firstname && "firstname" != beamer_config.user_firstname && (d += "&firstname=" +
            encodeURIComponent(beamer_config.user_firstname)), "undefined" != typeof beamer_config.user_email && "email" != beamer_config.user_email && (d += "&email=" + encodeURIComponent(beamer_config.user_email)));
    "undefined" !== typeof beamer_config.theme && ("undefined" === typeof beamer_config.display || "popup" !== beamer_config.display && "in-app" !== beamer_config.display && "compact" !== beamer_config.display) && (d += "&theme=" + beamer_config.theme);
    "undefined" != typeof beamer_config.header_color && (d += "&headerColor=" + encodeURIComponent(beamer_config.header_color));
    "undefined" != typeof beamer_config.standalone_logo && (d += "&standaloneLogoUrl=" + encodeURIComponent(beamer_config.standalone_logo));
    "undefined" != typeof beamer_config.product_name && (d += "&productName=" + encodeURIComponent(beamer_config.product_name));
    "undefined" != typeof b && (d += "&featureId=" + encodeURIComponent(b));
    "undefined" !== typeof beamer_config.hide_feedback && (d += "&hideFeedback=" + encodeURIComponent(beamer_config.hide_feedback));
    try {
...
Beamer.buildUnreadUrl = function (a, b, c, d) {
    ...
    e = ("undefined" !== typeof d && d ? e + "realtimeUpdates" : e + "numberFeatures") + ("?url=" + a + "&product=" + beamer_config.product_id + "&v=1");
    a = Beamer.getConfigParameter(beamer_config, "filterByUrl");
    "undefined" === typeof a && (a = beamer_config.filter_by_url);
    "undefined" === typeof a && (a = Beamer.getCookie(_BEAMER_FILTER_BY_URL + "_" + beamer_config.product_id), "undefined" !== typeof a && "" !== a.trim() && (beamer_config.filter_by_url = "true" === a || !0 === a ? !0 : !1));
    a = Beamer.getConfigParameter(beamer_config,
        "filterByUrl");
    "undefined" === typeof a && (a = beamer_config.filter_by_url);
    "undefined" !== typeof a && (a ? (a = encodeURIComponent(window.location.href), e += "&fullUrl=" + a, Beamer.fullUrl = a) : e += "&filterByUrl=false");
    beamer_config.language ? e += "&language=" + beamer_config.language : (a = window.navigator.userLanguage || window.navigator.language) && 1 < a.length && (a = a.substring(0, 2).toUpperCase(), e += "&language=" + a);
    "undefined" !== typeof beamer_config.role ? e += "&role=" + encodeURIComponent(beamer_config.role) : "undefined" !== typeof beamer_config.filter &&
        (e += "&role=" + encodeURIComponent(beamer_config.filter));
    "undefined" !== typeof beamer_config.force_filter && (e += "&force_filter=" + encodeURIComponent(beamer_config.force_filter));
    ...
    c && "undefined" !== typeof b &&
        null !== b && "" !== b ? e += "&user_id=" + c : c && !_BEAMER_MASSIVE && (e += "&user_id=" + c);
    "undefined" !== typeof beamer_config.user_id && "user_id" !== beamer_config.user_id && (e += "&custom_user_id=" + encodeURIComponent(beamer_config.user_id));
    "undefined" !== typeof beamer_config.user_token && "user_token" !== beamer_config.user_token && (e += "&user_token=" + encodeURIComponent(beamer_config.user_token));
    "undefined" !== typeof beamer_config.user_lastname && "lastname" !== beamer_config.user_lastname && (e += "&lastname=" + encodeURIComponent(beamer_config.user_lastname));
    "undefined" !== typeof beamer_config.user_firstname && "firstname" !== beamer_config.user_firstname && (e += "&firstname=" + encodeURIComponent(beamer_config.user_firstname));
    "undefined" !== typeof beamer_config.user_email && "email" !== beamer_config.user_email && (e += "&email=" + encodeURIComponent(beamer_config.user_email));
    "undefined" !== typeof d && d ? (e += "&auto=true", "undefined" !== typeof Beamer.lastUpdateTimestamp && (e += "&_=" + Beamer.lastUpdateTimestamp)) : (b = Beamer.getCookie(_BEAMER_LAST_UPDATE + "_" + beamer_config.product_id),
        "undefined" !== typeof b && null !== b && "" !== b && (e += "&_=" + b), "undefined" !== typeof beamer_config.source && "" !== beamer_config.source.trim() && (e += "&source=" + encodeURIComponent(beamer_config.source)));
    "undefined" !== typeof beamer_config.ignore_boosted_announcements && (e += "&ignoreBoosted=" + encodeURIComponent(beamer_config.ignore_boosted_announcements));
...
Beamer.appendCustomParameters = function (a) {
    for (var b in beamer_config)
        if (beamer_config.hasOwnProperty(b) && !(-1 < Beamer.reservedParameters.indexOf(b))) {
            ...
            "undefined" === typeof c || "object" === typeof c || Beamer.isFunction(c) || (-1 === b.indexOf("_at", b.length - 3) && -1 === b.indexOf("_blob", b.length - 5) && ("boolean" === typeof c ? b = "b_" + b : "number" === typeof c && (b = "n_" + b)), a += "&c_" + b + "=" + encodeURIComponent(c))
        } return a
};
Beamer.setParameters = function (a) {
    var b = Beamer.getConfigParameter(a, "pushNotificationPromptDelay");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.notification_prompt_delay && (beamer_config.notification_prompt_delay = b);
    ...
    b = Beamer.getConfigParameter(a,
        "enableEmbed");
    "undefined" === typeof b || b || (beamer_config.embed = !1);
    b = Beamer.getConfigParameter(a, "filterByUrl");
    "undefined" !== typeof b ? ("undefined" === typeof beamer_config.filter_by_url && (beamer_config.filter_by_url = b), Beamer.setCookie(_BEAMER_FILTER_BY_URL + "_" + beamer_config.product_id, b, .01334)) : Beamer.setCookie(_BEAMER_FILTER_BY_URL + "_" + beamer_config.product_id, !1, .01334);
    b = Beamer.getConfigParameter(a, "alert");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.alert && (beamer_config.alert =
        b);
    ...
    "undefined" !== typeof b && "undefined" === typeof beamer_config.ignore_auto_open && (beamer_config.ignore_auto_open = b);
    b = Beamer.getConfigParameter(a, "ignoreAutoOpenMobile");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.ignore_auto_open_mobile && (beamer_config.ignore_auto_open_mobile = b);
    b = Beamer.getConfigParameter(a,
        "bounce");
    ...
    "undefined" !== typeof b && ("undefined" === typeof beamer_config.selector || "undefined" !== typeof Beamer.defaultSelector && Beamer.defaultSelector || "undefined" !== typeof Beamer.noSelector && Beamer.noSelector) && (beamer_config.selector = b, Beamer.defaultSelector = !1, Beamer.noSelector = !1);
    b = Beamer.getConfigParameter(a, "feedbackButton");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.feedback_button &&
        (beamer_config.feedback_button = b);
    b = Beamer.getConfigParameter(a, "feedbackButtonPosition");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.feedback_button_position && (beamer_config.feedback_button_position = b);
    ...
    "undefined" !== typeof b && "undefined" === typeof beamer_config.ideas_form_selector &&
        (beamer_config.ideas_form_selector = b);
    b = Beamer.getConfigParameter(a, "roadmapSelector");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.roadmap_selector && (beamer_config.roadmap_selector = b);
    ...
    "undefined" !== typeof b && "undefined" === typeof beamer_config.button_position && (beamer_config.button_position = b);
    ...
    "undefined" !== typeof b && "undefined" === typeof beamer_config.display_position && (beamer_config.display_position = b);
    b = Beamer.getConfigParameter(a, "forceButton");
    "undefined" !== typeof b && "undefined" === typeof beamer_config.force_button &&
    ...
    "undefined" !== typeof a && ("undefined" !== typeof Beamer.config && Beamer.config || (Beamer.config = {}), Beamer.config.lastPushUpdateTime = a)
};
...
Beamer.drawAlert = function () {
    if (Beamer.isEmbedMode() || "undefined" !== typeof beamer_config.counter && !beamer_config.counter) Beamer.forEachElement(beamer_config.selector, function (d) {
        -1 === Beamer.elements.indexOf(d) && Beamer.elements.push(d)
    });
    else {
        var a = "1";
        null != Beamer.notificationNumber && 0 < Beamer.notificationNumber && (a = 99 < Beamer.notificationNumber ? "99+" : "" + Beamer.notificationNumber);
        var b = "beamer_icon";
        "undefined" !== typeof beamer_config.bounce && !1 === beamer_config.bounce && (b += " noBouncy");
        var c = "<div class='" +
            b + "' style='display: none;'>" + a + "</div>";
        Beamer.forEachElement(beamer_config.selector, function (d) {
            -1 < Beamer.elements.indexOf(d) ? d.getElementsByClassName("beamer_icon")[0].innerHTML = a : (Beamer.elements.push(d), Beamer.makeRelative(d), Beamer.appendHtml(d, c), ("undefined" == typeof beamer_config.alert || beamer_config.alert) && Beamer.isElementClickable(d) && (d = d.getElementsByClassName("beamer_icon")[0], Beamer.addClick(d, Beamer.toggle)))
        });
        Beamer.defaultSelector || Beamer.setPosition(".beamer_icon");
        Beamer.setColor(".beamer_icon",
            Beamer.notificationColor);
        Beamer.notificationActive && (_BEAMER_CSS_LOADED ? Beamer.clearDisplayFromElement(".beamer_icon") : setTimeout(function () {
            Beamer.clearDisplayFromElement(".beamer_icon")
        }, 5E3), Beamer.addClass(".beamer_icon", "active"))
    }
};
...
Beamer.buildDateCookieName = function (a) {
    ...
    "undefined" !== typeof beamer_config.multi_user && beamer_config.multi_user && "undefined" != typeof a && "user_id" != a && (b += "_" + a);
    return b
};
Beamer.updateBoostedAnnouncementDate = function (a, b) {
    "undefined" != typeof beamer_config.user_token && "user_token" != beamer_config.user_token && "" !== beamer_config.user_token ? (a = _BEAMER_URL_BACK + "updateBoostedDate?product=" + beamer_config.product_id + "&user_token=" + encodeURIComponent(beamer_config.user_token), Beamer.ajax(a)) : "undefined" != typeof beamer_config.user_id && "user_id" != beamer_config.user_id && "" !== beamer_config.user_id && (a = _BEAMER_URL_BACK + "updateBoostedDate?product=" + beamer_config.product_id + "&custom_user_id=" +
        encodeURIComponent(beamer_config.user_id), "undefined" != typeof beamer_config.user_token && "user_token" != beamer_config.user_token && "" !== beamer_config.user_token && (a += "&user_token=" + encodeURIComponent(beamer_config.user_token)), Beamer.ajax(a));
...
Beamer.trackViews = function (a, b) {
    ...
    beamer_config.language ? a += "&language=" + beamer_config.language : (b = window.navigator.userLanguage || window.navigator.language) && 1 < b.length && (b = b.substring(0, 2).toUpperCase(), a += "&language=" + b);
    "undefined" !== typeof beamer_config.role ? a += "&role=" + encodeURIComponent(beamer_config.role) : "undefined" !== typeof beamer_config.filter && (a += "&role=" + encodeURIComponent(beamer_config.filter));
    (b = Beamer.getCookie(_BEAMER_USER_ID + "_" + beamer_config.product_id)) && !_BEAMER_MASSIVE && (a += "&user_id=" + b);
    "undefined" != typeof beamer_config.user_token && "user_token" != beamer_config.user_token && (a += "&user_token=" + encodeURIComponent(beamer_config.user_token));
    "undefined" !== typeof beamer_config.user_id && "user_id" !== beamer_config.user_id && (a += "&custom_user_id=" + encodeURIComponent(beamer_config.user_id));
    "undefined" !== typeof beamer_config.user_lastname && "lastname" !== beamer_config.user_lastname && (a += "&lastname=" +
        encodeURIComponent(beamer_config.user_lastname));
    "undefined" !== typeof beamer_config.user_firstname && "firstname" !== beamer_config.user_firstname && (a += "&firstname=" + encodeURIComponent(beamer_config.user_firstname));
    "undefined" !== typeof beamer_config.user_email && "email" !== beamer_config.user_email && (a += "&email=" + encodeURIComponent(beamer_config.user_email));
...
Beamer.parseDate = function (a) {
    try {
        var b = a.split(/\D+/);
        return 7 === b.length ? new Date(Date.UTC(b[0], --b[1], b[2], b[3], b[4], b[5], b[6])) : new Date(Date.UTC(b[0], --b[1], b[2], b[3], b[4]))
    } catch (c) {
        try {
            return new Date(a)
        } catch (d) { }
...
Beamer.ajax = function (a, b, c, d, e) {
    ...
    f.onreadystatechange = function () {
        ...
        if (4 == h.readyState)
            ...
            else if (400 > h.status || 403 < h.status) 5 > e ? setTimeout(function () {
                Beamer.ajax(a, b, c, d, e)
            }, e * (36E4 * Math.random() + 36E4 *
                (e + 1))) : "undefined" !== typeof c && c && c(h.responseText)
    };
    try {
        f.crossDomain = !0
    } catch (h) { }
        ...
        for (var d = 0; d < a.length; d++) {
            ...
            if (e.startsWith("a[")) {
                ...
                for (e = document.getElementsByClassName(e.replace(".", "")), g = 0; g < e.length; g++) {
                    ...
                    f && c(f, b)
                } else (e = document.getElementById(e.replace("#",
                    ""))) && c(e, b)
        }
    }
    return b
...
Beamer.openUrl = function (a, b, c) {
    if (!(a.trim().toLowerCase().startsWith("javascript") || -1 < a.replace(/\s+/ig, "").toLowerCase().indexOf("javascript:"))) {
...
Beamer.openCta = function (a, b, c, d, e) {
    ...
    "undefined" !== typeof beamer_config.user_token && (f += "&user_token=" + encodeURIComponent(beamer_config.user_token));
    ...
    h = _BEAMER_URL + "redirectTo?address=" + encodeURIComponent(a) + "&product=" + encodeURIComponent(beamer_config.product_id) + "&descriptionId=" + d + f;
    "undefined" !== typeof e && (h += "&origin=" + encodeURIComponent(e));
    "undefined" !== typeof navigator.sendBeacon ? (navigator.sendBeacon(h), g()) : Beamer.ajax(h, g, function () {
...
Beamer.bindEscape = function () {
    try {
        Beamer.addEventListener(document, "keydown", function (a) {
            try {
                27 == ("which" in a ? a.which : a.keyCode) && (0 < Beamer.findElements("beamerPicture").length ? Beamer.hidePicture() : _BEAMER_IS_OPEN && (Beamer.isEmbedMode() || Beamer.hide()))
            } catch (b) { }
        })
    } catch (a) { }
};
...
Beamer.buildStandaloneUrl = function () {
    if ("undefined" !== typeof Beamer.customDomain) {
        ...
        "undefined" != typeof beamer_config.role ? a += "?role=" + encodeURIComponent(beamer_config.role) : "undefined" != typeof beamer_config.filter && (a += "?role=" + encodeURIComponent(beamer_config.filter))
    } else a = _BEAMER_URL + "standalone?", a = "undefined" != typeof beamer_config.product_id ? a + ("app_id=" + beamer_config.product_id) : a + ("id=" + beamer_config.product_id),
        "undefined" != typeof beamer_config.role ? a += "&role=" + encodeURIComponent(beamer_config.role) : "undefined" != typeof beamer_config.filter && (a += "&role=" + encodeURIComponent(beamer_config.filter)), beamer_config.language && (a += "&language=" + beamer_config.language);
    return a
};
Beamer.sendMessageToIframe = function (a, b) {
    Beamer.forEachElement(b ? b : "beamerNews", function (c) {
        c && c.contentWindow ? c.contentWindow.postMessage(a, "*") : setTimeout(function () {
...
Beamer.clearProductStorage = function () {
    ...
    Beamer.removeCookie(_BEAMER_LAST_PUSH_PROMPT_INTERACTION +
        "_" + beamer_config.product_id);
    ...
    "undefined" !== typeof _BEAMER_NPS_LAST_SHOWN && Beamer.removeCookie(_BEAMER_NPS_LAST_SHOWN + "_" + beamer_config.product_id);
...
Beamer.initDomObserver = function () {
    if (!Beamer.observing && "MutationObserver" in window) try {
        Beamer.domMutated = !1, Beamer.domObserver = new MutationObserver(function () {
            Beamer.domMutated = !0;
            Beamer.pauseDomObserver()
        }), Beamer.startDomObserver(), Beamer.observing = !0, Beamer.domMutationsProcessInterval = setInterval(Beamer.processDomMutations, 2E3)
    } catch (a) { }
};
...
Beamer.stopDomObserver = function () {
    Beamer.observing && Beamer.domObserver && (Beamer.pauseDomObserver(), delete Beamer.domObserver, Beamer.observing = !1, "undefined" !== typeof Beamer.domMutationsProcessInterval && (clearInterval(Beamer.domMutationsProcessInterval), delete Beamer.domMutationsProcessInterval))
};
    ...
    try {
        if (Beamer.domMutated) {
            ...
            Beamer.forEachElement(beamer_config.selector, function (b) {
                -1 === Beamer.elements.indexOf(b) && (a = !0, "undefined" == typeof beamer_config.alert || beamer_config.alert) && (Beamer.addClass(b, "beamer_beamerSelector"), Beamer.isElementClickable(b) && (Beamer.addClick(b, Beamer.toggle), Beamer.removeHref(b)));
                !_BEAMER_IS_OPEN && Beamer.isInApp() && Beamer.isElementVisible(b) && Beamer.forEachElement("beamerNews, beamerLoader", function (c) {
                    Beamer.setPopperPosition(c,
                        b);
                    Beamer.initPopper(c, b)
                })
            });
            a && ("undefined" == typeof beamer_config.alert || beamer_config.alert || "undefined" !== typeof beamer_config.counter && beamer_config.counter) && ("undefined" == typeof beamer_config.counter || beamer_config.counter) && Beamer.drawAlert();
            Beamer.appendFeedbackButtons();
...
Beamer.stopUrlObserver = function () {
    Beamer.observingUrl && (clearInterval(Beamer.urlObserverInterval), delete Beamer.urlObserverInterval, Beamer.observingUrl = !1)
};
    ...
    try {
        if (Beamer.enableSoundNotification) {
            ...
            if (void 0 !== a && null !== a && "" !== a) {
                ...
                if (void 0 === c || null === c || "true" != c) "Audio" in window && ("undefined" == typeof Beamer.soundNotification && (Beamer.soundNotification = new Audio(_BEAMER_URL + "audio/notification.mp3"), Beamer.soundNotification.volume = .2), Beamer.soundNotification.play()["catch"](function (d) {
                    try {
    ...
    try {
        if (Beamer.enableFaviconNotification && "Favico" in window) {
            if ("undefined" == typeof Beamer.favicons) {
                Beamer.favicons = [];
                for (var a = document.getElementsByTagName("head")[0].getElementsByTagName("link"), b = 0; b < a.length; b++) /(^|\s)icon(\s|$)/i.test(a[b].getAttribute("rel")) && Beamer.favicons.push(new Favico({
                    animation: "fade",
...
Beamer.initPopper = function (a, b, c) {
    ...
    d = !0 === Beamer.enableTooltipAutoFlipControl ? {
        placement: "auto",
        modifiers: {
            flip: {
                behavior: ["bottom", "right", "top", "left"]
            },
            offset: {
                offset: "0,8"
            },
    ...
    "undefined" !== typeof c && c ? d.modifiers.offset = {
        offset: "0,15"
    } : (d.modifiers.offset = {
        offset: "10,10"
    }, d.modifiers.arrow = {
    ...
    "undefined" !== typeof beamer_config.display_position && ("top-right" === beamer_config.display_position ? d.placement = "top-end" : "right-top" === beamer_config.display_position ? d.placement = "right-start" : "right" === beamer_config.display_position ? d.placement = "right" : "right-bottom" === beamer_config.display_position ? d.placement = "right-end" : "bottom-right" === beamer_config.display_position ? d.placement =
        ...
        (d.modifiers.preventOverflow.enabled = !1), d.modifiers.flip.enabled = !1);
    d = new Popper(b, a, d);
    "undefined" !== typeof c && c || d.disableEventListeners();
    Beamer.popperElements.push({
        element: a,
        popper: d,
        container: b
    })
...
Beamer.updatePopper = function (a) {
    for (var b = 0; b < Beamer.popperElements.length; b++) "undefined" !== typeof a && Beamer.popperElements[b].container !== a || Beamer.popperElements[b].popper.scheduleUpdate()
};
    ...
    function u() {
        var v = setInterval(function () {
            if ("undefined" !== typeof Popper) {
                clearInterval(v);
                var m = new IntersectionObserver(function (q, r) {
    ...
    var w = function () {
        if ("undefined" === typeof Popper) setTimeout(w, 1500);
            ...
            if (v) {
                ...
                m &&
                    0 !== m.length ? m = m[0] : (Beamer.appendHtml(document.body, '<div id="beamerLastPostTitle"></div>'), m = Beamer.findElements("beamerLastPostTitle")[0]);
                "undefined" !== typeof e && e ? Beamer.addClass("beamerLastPostTitle", "rtl") : Beamer.removeClass("beamerLastPostTitle", "rtl");
                m.onclick = function (p) {
                    -1 === p.target.className.indexOf("beamerTitleWatermark") && -1 === p.target.className.indexOf("beamerTitleWatermarkLink") && ("undefined" !== typeof l && l ? (Beamer.closeLastPostTitle(p), "undefined" !== typeof g ? window.open(g, "_blank",
                        "noopener,noreferrer") : BeamerPreview.show()) : "undefined" !== typeof g && "" !== g.trim() ? (Beamer.openCta(g, f, a, b, "boosted-tooltip"), Beamer.closeLastPostTitle(p)) : Beamer.show())
                };
                var q = "";
                "undefined" !== typeof c && c && (q = '<span class="beamerCategory" style="background-color:' + d + '">' + Beamer.escapeHtml(c) + "</span>");
                q = q + '<span class="beamerTitle">' + Beamer.escapeHtml(a) + '</span><svg class="beamerClose" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path><path d="M0 0h24v24H0z" fill="none"></path></svg><div class="popper__arrow" x-arrow></div>';
                "undefined" !== typeof h && h && "" !== h && (q += '<div class="beamerTitleWatermark"><a class="beamerTitleWatermarkLink" href="' + h + '" target="_blank">by Beamer</a></div>');
                m.innerHTML = q;
                Beamer.forEachElement(beamer_config.selector, function (p) {
                ...
                setTimeout(function () {
                    ...
                    Beamer.removeEventListener(m,
                        "mouseenter", Beamer.clearLastPostTitleClose);
                ...
                "undefined" !== typeof l && l || (Beamer.setCookie(_BEAMER_LAST_POST_SHOWN + "_" + beamer_config.product_id,
                    b, 300), "undefined" !== typeof k && k && ("undefined" !== r && r && Beamer.updateBoostedAnnouncementDate(), Beamer.trackViews(b, n)))
            }
        }
    };
    if (void 0 !== Beamer.enableHiddenTooltipObserver && !0 === Beamer.enableHiddenTooltipObserver) Beamer.onWindowVisible(u);
...
Beamer.closeLastPostTitle = function (a, b) {
    ...
    Beamer.forEachElement("beamerLastPostTitle", function (c) {
        setTimeout(function () {
            "undefined" !== typeof c && c && "undefined" !== typeof c.parentNode && c.parentNode && c.parentNode.removeChild(c)
        }, 500)
    });
...
Beamer.clearLastPostTitleClose = function () {
    "undefined" !== typeof Beamer.lastPostTitleCloseTimeout && Beamer.lastPostTitleCloseTimeout && (clearTimeout(Beamer.lastPostTitleCloseTimeout), delete Beamer.lastPostTitleCloseTimeout)
};
Beamer.initVisibilityObserver = function () {
    try {
        ...
        } else "undefined" !== typeof document.msHidden ? (a = "msHidden", b = "msvisibilitychange") : "undefined" !== typeof document.webkitHidden && (a = "webkitHidden", b = "webkitvisibilitychange");
        Beamer.updateWindowVisibility(0 == document[a]);
        Beamer.visibilityObserverInitialized || (Beamer.addEventListener(document, b, function (c) {
            Beamer.updateWindowVisibility(0 == document[a])
...
Beamer.bindWindowEvents = function () {
    Beamer.addEventListener(window, "message", function (a) {
        var b = "https://app.getbeamer.com" === a.origin || "https://push.getbeamer.com" === a.origin || "https://backend.getbeamer.com" === a.origin;
        b || "undefined" === typeof Beamer.customDomain || (b = 0 === Beamer.customDomain.indexOf(a.origin));
        if (a.data && "string" === typeof a.data && "{" !== a.data[0] && -1 < a.data.indexOf(":")) try {
            ...
            a.data;
        if (b || ("requestNotificationsPermission" == d || "removeNotificationsIframe" == d || "refuseNotifications" == d || "openNotificationsPopup" == d) && 0 === window.location.href.indexOf(a.origin)) {
            if ("hide" == d) Beamer.hide();
            else if ("hidePreview" == d) BeamerPreview.hide();
            else if ("loaded" == d) Beamer.hideLoader(), a = "setRefUrl:" + JSON.stringify({
                url: window.location.href
            }), Beamer.sendMessageToIframe(a), Beamer.sendMessageToIframe(a, "beamerAnnouncementPopup");
            else if ("showPicture" == d) Beamer.showPicture(e.url);
            else if ("hidePicture" ==
                d) Beamer.hidePicture();
                ...
                if (beamer_config.onInputFocus &&
                    Beamer.isFunction(beamer_config.onInputFocus)) beamer_config.onInputFocus(e.context, e.title)
            } else if ("triggerInputBlur" == d) {
                if (beamer_config.onInputBlur && Beamer.isFunction(beamer_config.onInputBlur)) beamer_config.onInputBlur(e.context, e.title)
            } else "requestUserData" == d ? Beamer.sendUserData(e.id) : "updatesAvailable" == d ? ("undefined" !== typeof Beamer.updateTimeout && clearTimeout(Beamer.updateTimeout), "undefined" !== typeof e && "undefined" !== typeof e.immediate && e.immediate ? (Beamer.appendAlert(!0), delete Beamer.updateTimeout) :
                Beamer.updateTimeout = setTimeout(function () {
                    Beamer.appendAlert(!0);
                    delete Beamer.updateTimeout
                }, Math.max(100, Math.ceil(Math.random() * Beamer.updatesMaxDelay)))) : "prepareAutoRefresh" == d ? Beamer.prepareAutoRefresh() : "switchIframe" == d && Beamer.switchIframe(e.url);
...
Beamer.unbindWindowEvent = function (a, b) {
    "undefined" === typeof Beamer.windowEventCallbacks && (Beamer.windowEventCallbacks = {});
    "undefined" === typeof Beamer.windowEventCallbacks[a] && (Beamer.windowEventCallbacks[a] = []);
    b = Beamer.windowEventCallbacks[a].indexOf(b); - 1 < b && Beamer.windowEventCallbacks[a].splice(b)
};
Beamer.appendScript = function (a, b, c) {
    try {
        var d = document.getElementById(a);
        d || (d = document.createElement("script"), d.id = a, d.type = "text/javascript", d.onload = c, d.src = b, document.head.appendChild(d))
    } catch (e) { }
};
Beamer.appendCSS = function (a, b) {
    var c = document.getElementById(a);
    c || (c = document.createElement("link"), c.id = a, c.type = "text/css", c.rel = "stylesheet", c.href = b, document.head.appendChild(c))
};
Beamer.logError = function (a) {
    ...
    try {
        if ("undefined" !== typeof c && c && "" !== c && (c = JSON.parse(c), "undefined" !== typeof c.error && c.error == b && 36E5 > a - c.time)) return
    } catch (e) { }
    ...
    c = Beamer.getCookie(_BEAMER_USER_ID +
        "_" + beamer_config.product_id);
...
Beamer.buildUserData = function () {
    ...
    "undefined" !== typeof beamer_config.user_lastname && (a.lastname =
...
Beamer.shouldShowNPS = function (a, b) {
    ...
    try {
        ...
        if ("undefined" !== typeof b && 0 < b.length)
            for (e = 0; e < b.length; e++) try {
                if (g = new RegExp(b[e].replace(/[-[\]{}()+?.,\\^$|#\s]/g, "\\$&").replace(/\*/g, ".*")), g.test(c)) return !1
            } catch (f) { }
    } catch (f) { }
    return d
};
    ...
    return new Promise(function (b, c) {
        try {
            ...
            if ("undefined" !== typeof a.blockedUrls) {
                ...
                d.push(Promise.all(f).then(function (h) {
            ...
            if ("undefined" !== typeof a.allowedUrls) {
                f = [];
                for (g = 0; g < a.allowedUrls.length; g++) f.push(Beamer.matchesUrlParts(e.slice(),
                    a.allowedUrls[g].slice()));
                d.push(Promise.all(f).then(function (h) {
                    for (var k = 0; k < h.length; k++)
                        if (h[k]) return !0;
                    return !1
...
Beamer.matchesUrlPart = function (a, b, c, d, e) {
    ...
    return Beamer.hash(e).then(function (g) {
        return g !== d ? "undefined" !== typeof c && c && 0 < a.length ? Beamer.matchesUrlParts(a, b, !0, d) : 0 < b.length && "*" === b[0] ? 1 < e.length ? Beamer.matchesUrlPart(a, b, c, d, e.slice(0, -1)) : Beamer.matchesUrlParts(a, b, !0, d) : !1 : Beamer.matchesUrlParts(a, b)
    })
};
Beamer.hash = function (a) {
    return "*" === a ? Promise.resolve(a) : crypto.subtle.digest("SHA-512", (new TextEncoder).encode(a)).then(function (b) {
        return Array.from(new Uint8Array(b)).map(function (c) {
            return c.toString(16).padStart(2, "0")
        }).join("")
    })
};
Beamer.isEmbedMode = function () {
    return "undefined" !== typeof beamer_config.embed && beamer_config.embed && "undefined" !== typeof beamer_config.selector && '.beamerTrigger,a[href="#beamerTrigger"]' !== beamer_config.selector && '.beamerTrigger,a[href="#beamerTrigger"], beamerSelector' !== beamer_config.selector ? !0 : !1
};
Beamer.build();